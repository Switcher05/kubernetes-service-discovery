...
import za.co.bsg.config.Constants;
import za.co.bsg.UaaApp;
import za.co.bsg.domain.Authority;
import za.co.bsg.domain.User;
import za.co.bsg.repository.AuthorityRepository;
import za.co.bsg.repository.UserRepository;
import za.co.bsg.security.AuthoritiesConstants;
import za.co.bsg.service.MailService;
import za.co.bsg.service.dto.UserDTO;
import za.co.bsg.web.rest.errors.ExceptionTranslator;
import za.co.bsg.web.rest.vm.KeyAndPasswordVM;
import za.co.bsg.web.rest.vm.ManagedUserVM;
import za.co.bsg.service.UserService;
