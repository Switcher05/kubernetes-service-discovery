...
import za.co.bsg.config.audit.AuditEventConverter;
import za.co.bsg.domain.PersistentAuditEvent;
...
import static za.co.bsg.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
